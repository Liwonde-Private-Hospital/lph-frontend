          ...
          <div className="bg-white">
            <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
              ...
              <div className="mt-20 grid grid-cols-2 grid-rows-1 gap-4 sm:gap-6 lg:gap-8">
                ...
                <Image src="https://scontent-jnb2-1.xx.fbcdn.net/v/t39.30808-6/441910845_847629340717160_8364228998593965139_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=5f2048&_nc_ohc=xAjiv3XP50kQ7kNvgEuCPM4&_nc_ht=scontent-jnb2-1.xx&oh=00_AYBo_rUTzU1BrfqTYa1LrqpeKMP9EuyF-fe0qjZLbk11rA&oe=6658DB6E" height="500" width="500" alt="Liwonde External" />
