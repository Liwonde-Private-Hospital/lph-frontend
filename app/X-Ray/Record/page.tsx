    ...
    return (
        <div>
            <div id="table">
                ...
                />
                <div>
                    <h1 className="Tsikuli">Radiology</h1>
                    ...
                    <div className="table-row" key={index}>
                        ...
                        <div className="table-cell">
                            ...
                            >
                                ...
                                <option value="">Nation Bank</option>
                                <option value="">Reserve Bank</option>
                                <option value="">WaterBoard</option>
                                <option value="">Escom</option>
                                <option value="">Med Health</option>
                            </select>
                        </div>
                        <div className="table-cell">
...
function setDataModified(arg0: boolean) {
