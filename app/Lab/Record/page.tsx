      ...
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-lg overflow-hidden"> {/* Increased max-w-4xl to max-w-5xl */}
        ...
        <div className="p-6">
          ...
          <div className="flex justify-center mt-4">
            <button className="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-md mr-2" onClick={addRow}>Add Row</button>
            <button className="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-md" onClick={handleSubmit}>Save</button>
          </div>
        </div>
      </div>
    </div>
