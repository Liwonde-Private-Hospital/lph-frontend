...
const MaternitySideBar: React.FC<SideBarProps> = ({ children }) => {
  const [isDrawerOpen, setIsDrawerOpen] = useState(false);

  const handleLogout = async () => {
    await logout(LPHStaffRole.MATERNITY);
  };
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              <header className="text-lg font-semibold p-4">
                <Link href="/departments/Maternity/Dashboard">
                Maternity Dashboard
                </Link>
              </header>
              <nav>
...
export default MaternitySideBar;
