...
const MedHealth = () => {
  ...
  const exportToPDF = () => {
    const doc = new jsPDF();
    const title = "NKHOKWE FERTLIZER COMPANY SUMMARY";
    ...
    doc.setFontSize(14);
    doc.text(
      `NKHOKWE FERTLIZER SUMMARY AS AT ${selectedDate.toLocaleString("en-US", {
        month: "long",
        year: "numeric",
      })}`,
      20,
    ...
    const filename = `NkhokweFertlizer_Summary_${formattedDate}.pdf`;
    doc.save(filename);
  };
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <div className="text-center mt-4">
                  ...
                  NKHOKWE FERTLIZER SUMMARY AS AT{" "}
                    {new Date(
                      selectedYear,
                      selectedMonth - 1
