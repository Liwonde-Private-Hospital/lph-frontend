...
const MedHealth = () => {
  ...
  const exportToPDF = () => {
    const doc = new jsPDF();
    const title = "RESERVE BANK SUMMARY";
    ...
    doc.setFontSize(14);
    doc.text(
      `RESERVE BANK SUMMARY AS AT ${selectedDate.toLocaleString("en-US", {
        month: "long",
        year: "numeric",
      })}`,
      20,
    ...
    const filename = `ReserveBank_Summary_${formattedDate}.pdf`;
    doc.save(filename);
  };
