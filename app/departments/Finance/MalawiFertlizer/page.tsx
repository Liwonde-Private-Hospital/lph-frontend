...
const MedHealth = () => {
  ...
  const exportToPDF = () => {
    const doc = new jsPDF();
    const title = "MALAWI FERTLIZER COMPANY SUMMARY";
    ...
    doc.setFontSize(14);
    doc.text(
      `MALAWI FERTLIZER SUMMARY AS AT ${selectedDate.toLocaleString("en-US", {
        month: "long",
        year: "numeric",
      })}`,
      20,
    ...
    const filename = `MalawiFertilizer_Summary_${formattedDate}.pdf`;
    doc.save(filename);
  };
              ...
              <div className="ml-4">
                ...
                <div className="text-center mt-4">
                  <p className="font-bold text-xl">
                    MALAWI FERTLIZER  SUMMARY AS AT{" "}
                    {new Date(
                      selectedYear,
                      selectedMonth - 1
