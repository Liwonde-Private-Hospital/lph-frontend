...
const MedHealth = () => {
  ...
  const exportToPDF = () => {
    const doc = new jsPDF();
    const title = "WATERBOARD SUMMARY";
    ...
    doc.setFontSize(14);
    doc.text(
      `WATERBOARD SUMMARY AS AT ${selectedDate.toLocaleString("en-US", {
        month: "long",
        year: "numeric",
      })}`,
      20,
    ...
    const filename = `WaterBoard_Summary_${formattedDate}.pdf`;
    doc.save(filename);
  };
