      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <div className="flex items-center justify-between bg-gray-800 text-white p-4">
          <div className="flex items-center">
            <div className="ml-4">
              <h1 className="text-4xl font-bold">Vitals  Transaction History</h1>
            </div>
                ...
                <table className="w-full border-collapse border border-gray-300">
                  <thead>
                    <tr>
                      ...
                      <th className="px-4 py-2 bg-gray-200 border border-gray-300">FirstName</th>
                      <th className="px-4 py-2 bg-gray-200 border border-gray-300">LastName</th>
                      <th className="px-4 py-2 bg-gray-200 border border-gray-300">Temperature</th>
                      <th className="px-4 py-2 bg-gray-200 border border-gray-300">Height</th>
                      <th className="px-4 py-2 bg-gray-200 border border-gray-300">weight</th>
                      <th className="px-4 py-2 bg-gray-200 border border-gray-300">BloodPressure</th>
                      <th className="px-4 py-2 bg-gray-200 border border-gray-300">BMI</th>
