...
const VitalsSideBar: React.FC<SideBarProps> = ({ children }) => {
  const [isDrawerOpen, setIsDrawerOpen] = useState(false);

  const handleLogout = async () => {
    await logout(LPHStaffRole.VITALS);
  };
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              <header className="text-lg font-semibold p-4">
                <Link href="/departments/Vitals/Dashboard">
                Vitals Dashboard
                </Link>
              </header>
              <nav>
                  ...
                  items={[
                    {
                      ...
                      link: "/departments/Vitals/History",
                    },
                  ]}
                />
                <hr className="my-2" />
                <MenuItem
                  ...
                  link="/departments/Vitals/Record"
                />
                <MenuItem
                  title="View Todays Data"
                  icon={<FaCog className="h-5 w-5" />}
                  link="/departments/Vitals/ViewData"
                />
                <MenuItem
                  title="Profile"
                  link="#"
