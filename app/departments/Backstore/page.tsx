...
const BackstoreSideBar: React.FC<SideBarProps> = ({ children }) => {
  const [isDrawerOpen, setIsDrawerOpen] = useState(false);

  const handleLogout = async () => {
    await logout(LPHStaffRole.BACKSTORE);
  };
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              <header className="text-lg font-semibold p-4">
                <Link href="/departments/Backstore/Dashboard">
                  Backstore Dashboard
                </Link>
              </header>
              <nav>
...
export default BackstoreSideBar;
