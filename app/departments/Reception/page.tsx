...
const ReceptionSideBar: React.FC<SideBarProps> = ({ children }) => {
  const [isDrawerOpen, setIsDrawerOpen] = useState(false);

  const handleLogout = async () => {
    await logout(LPHStaffRole.RECEPTION);
  };
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              <header className="text-lg font-semibold p-4">
                <Link href="/departments/Reception/Dashboard">
                Reception Dashboard
                </Link>
              </header>
              <nav>
                  ...
                  items={[
                    {
                      ...
                      link: "/departments/Reception/History",
                    },
                  ]}
                />
                <hr className="my-2" />
                <MenuItem
                  ...
                  link="/departments/Reception/Record"
                />
                <MenuItem
