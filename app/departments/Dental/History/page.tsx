      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <div className="flex items-center justify-between bg-gray-800 text-white p-4">
          <div className="flex items-center">
            <div className="ml-4">
              <h1 className="text-4xl font-bold">Dental  Transaction History</h1>
            </div>
                ...
                <table className="w-full border-collapse border border-gray-300">
                  <thead>
                    <tr>
                      ...
                      <th className="px-4 py-2 bg-gray-200 border border-gray-300">PhoneNumber</th>
                      <th className="px-4 py-2 bg-gray-200 border border-gray-300">Address</th>
                      <th className="px-4 py-2 bg-gray-200 border border-gray-300">Diagnosis</th>
                        ...
                        <tr key={item.id}>
                          ...
                          <td className="px-4 py-2 border border-gray-300">
                            <input
                              type="number"
                              className="w-full bg-transparent focus:outline-none"
                              value={item.TestOrdered.toString()}
                              onChange={(event) =>
                                updateRow(index, {
                                  ...item,
