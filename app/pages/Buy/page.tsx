        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Liwonde Private Hospital (LPH) has a rich history of providing
              Scarcity drugs to its community. Founded in 1999, LPH has been a
              cornerstone in the medical field, striving for excellence and
