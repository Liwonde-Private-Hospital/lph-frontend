...
export default function Example() {
  ...
  const handleSubscribe = () => {
    if (email.includes("@") && email.includes(".com")) {
      ...
      setAlert("Invalid email format. Please enter a valid email address ❌.");
      setAlert("failed to subscribed to our newsfeed");
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
            <div className="max-w-xl lg:max-w-lg">
              ...
              <p className="mt-4 text-lg leading-8 text-gray-300">
                Stay updated with the latest news, events, and health tips from
            ...
            <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
              <div className="flex flex-col items-start">
                ...
                <dd className="mt-2 leading-7 text-gray-400">
                  Get insightful articles on healthcare, wellness, and medical
                  advancements delivered weekly.
                </dd>
              </div>
              <div className="flex flex-col items-start">
                <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                ...
                <dd className="mt-2 leading-7 text-gray-400">
                  We respect your privacy. You will only receive relevant
