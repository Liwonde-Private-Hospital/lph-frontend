      ...
      <div className="divyadept">
        <div className="deptinfo">
          ...
          <div className="infoija">
            ...
            <p className="deptdis">
              The Operation Theatre is a vital part of our healthcare facility,
              designed for safe and efficient surgical procedures. Equipped with
              advanced technology and staffed by experienced surgeons,
              anesthetists, and nurses, we ensure top-notch patient care and
              safety. Our theatres support various surgical specialties and
              maintain strict aseptic conditions to minimize infection risks. We
              are dedicated to providing a supportive and compassionate
              environment, ensuring a smooth surgical experience from
