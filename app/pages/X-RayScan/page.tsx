      ...
      <div className="divyadept">
        <div className="deptinfo">
          ...
          <div className="infoija">
            ...
            <p className="deptdis">
              The Department of Radiology is a cornerstone of our healthcare
              facility, dedicated to providing high-quality imaging services to
              aid in the diagnosis and treatment of various medical conditions.
              Equipped with cutting-edge technology, our department offers a
              comprehensive range of imaging modalities, including X-ray,
              ultrasound, computed tomography (CT), magnetic resonance imaging
              (MRI), and Scanning Services.
